...
export default function Header() {
  ...
  return (
    <header className="w-full py-[24px] px-[32px] grid grid-flow-col grid-cols-[30%_auto] gap-[32px]">
      <div>
        <h1 className="text-[20px] font-[600] text-primary">London Internship Program</h1>
      ...
      <div className=" w-full  grid grid-flow-col gap-2  items-center grid-cols-[auto_max-content]">
              ...
              return (
                {
                  ...
                  label: (
                    <div className={`
                      ...
                      ${categoryFilter === filter.label ? "bg-[#EDF2FF] shadow-[0px_4px_25px_0px_rgba(29,78,216,0.05)] text-primary" : ""} 
                      ${index === filters.length - 1 ? "" : "border-b-[1px] border-[#EEE]"}
                    `}>
                      <span className="text-[16px]">{filter.label}</span>
                      <span className={`bg-[#F8F8F8] py-[2px] px-[10px] rounded-3xl ${categoryFilter === filter.label ? "bg-[#D1DDFF]" : ""}`}>{filter.count}</span>
                    </div>
                  ),
                  className: "!p-0",
                  onClick: (ev) => {
        ...
        >
          <button className="flex justify-between items-center text-[16px]">
            {categoryFilter || <span className="text-[#dadada]">Select a category</span>}
        ...
        <div className=" grid grid-flow-col gap-[8px] justify-between items-center">
          <Button>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M12.96 5.28L19.3425 11.6625C20.1 12.42 20.1 13.6425 19.3425 14.4L13.77 19.9725C13.0125 20.73 11.79 20.73 11.0325 19.9725L4.65002 13.59C4.29002 13.23 4.08002 12.735 4.08002 12.225V6.6525C4.08002 5.5875 4.95002 4.7175 6.01502 4.7175H11.5875C12.105 4.7175 12.6 4.92 12.96 5.28Z" stroke="#444444" stroke-width="0.7" strokeMiterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M8.58004 10.2525C9.15579 10.2525 9.62254 9.78577 9.62254 9.21001C9.62254 8.63425 9.15579 8.16751 8.58004 8.16751C8.00428 8.16751 7.53754 8.63425 7.53754 9.21001C7.53754 9.78577 8.00428 10.2525 8.58004 10.2525Z" stroke="#444444" stroke-width="0.7" strokeMiterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </Button>
          <Button>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              ...
              <div className="flex items-center justify-center border-l-[1px] p-[10px] h-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                  <g clip-path="url(#clip0_18_353)">
                    <path d="M11.06 5.72665L8 8.77999L4.94 5.72665L4 6.66665L8 10.6667L12 6.66665L11.06 5.72665Z" fill="white" />
                  </g>
                  <defs>
